...
DEFAULT_INPUT_FILES = [
    ...
    BASE_DIR / "matching" / "matched_routes.rou.xml",
    BASE_DIR / "matching" / "matched_routes_shuffled_depart.rou.xml",
]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Merge route XML files into analysis/basic_data.rou.xml.",
    )
    parser.add_argument(
        "input_files",
        nargs="*",
